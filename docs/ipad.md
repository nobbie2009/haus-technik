...
- Die Bereichs-Tabs liegen oberhalb des Plans. **Menüband** klappt das gesamte Ribbon darunter ein und aus;
  ein Tabwechsel öffnet es. Die Werkzeuggruppen lassen sich bei Bedarf waagerecht verschieben.
- Geschosse und Ebenen stehen als feste Gruppen neben den Zeichenwerkzeugen. Der Geschossname und
  **Ebenen** oben springen zur jeweiligen Gruppe. Geschosse direkt dort anlegen und bearbeiten sowie
  Ebenen einblenden und sperren. Das Ribbon lässt sich waagerecht verschieben; der Plan bleibt bedienbar.
