...
test("Touch: Sicherung als Leitungsabgang wählen", async ({ page }) => {
  ...
  await page.getByLabel("Verbindung 3 · Startkontakt", { exact: true }).selectOption(`${feeder}:L1`);
  await page.getByLabel("Verbindung 3 · Zielkontakt", { exact: true }).selectOption("L");
